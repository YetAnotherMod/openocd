...
enum SPR_REG_NUM {
    ...
    SPR_REG_NUM_DAC1 = SPR_REG_NUM_DAC_BASE,
    SPR_REG_NUM_DAC2 = SPR_REG_NUM_DAC_BASE+1,
    SPR_REG_NUM_DCDBTRH = 925,
    SPR_REG_NUM_DCDBTRL = 924,
    SPR_REG_NUM_DEAR = 61,
    SPR_REG_NUM_DVC1 = 318,
    SPR_REG_NUM_DVC2 = 319,
    SPR_REG_NUM_DCESR = 850,
    SPR_REG_NUM_DCRIPR = 891,
    SPR_REG_NUM_DBCR0 = 308,
    SPR_REG_NUM_DBCR1 = 309,
    SPR_REG_NUM_DBCR2 = 310,
    SPR_REG_NUM_DBDR = 1011,
    SPR_REG_NUM_DBSR_RC = 304,
    SPR_REG_NUM_DBSR_WO = 816,
    SPR_REG_NUM_DEC = 22,
    SPR_REG_NUM_DECAR = 54,
    SPR_REG_NUM_ESR = 62,
    SPR_REG_NUM_ICESR = 851,
    SPR_REG_NUM_IAC_BASE = 312, /* IAC1..IAC4 */
    SPR_REG_NUM_IAC1 = SPR_REG_NUM_IAC_BASE,
    SPR_REG_NUM_IAC2 = SPR_REG_NUM_IAC_BASE+1,
    SPR_REG_NUM_IAC3 = SPR_REG_NUM_IAC_BASE+2,
    SPR_REG_NUM_IAC4 = SPR_REG_NUM_IAC_BASE+3,
    SPR_REG_NUM_ICDBDR0 = 979,
    SPR_REG_NUM_ICDBDR1 = 980,
    SPR_REG_NUM_ICDBTRH = 927,
    SPR_REG_NUM_ICDBTRL = 926,
    SPR_REG_NUM_IOCCR = 860,
    SPR_REG_NUM_IOCR1 = 861,
    SPR_REG_NUM_IOCR2 = 862,
    SPR_REG_NUM_XER = 1,
    SPR_REG_NUM_IVOR_BASE = 400,
    SPR_REG_NUM_IVOR0  = SPR_REG_NUM_IVOR_BASE + 0,
    SPR_REG_NUM_IVOR1  = SPR_REG_NUM_IVOR_BASE + 1,
    SPR_REG_NUM_IVOR2  = SPR_REG_NUM_IVOR_BASE + 2,
    SPR_REG_NUM_IVOR3  = SPR_REG_NUM_IVOR_BASE + 3,
    SPR_REG_NUM_IVOR4  = SPR_REG_NUM_IVOR_BASE + 4,
    SPR_REG_NUM_IVOR5  = SPR_REG_NUM_IVOR_BASE + 5,
    SPR_REG_NUM_IVOR6  = SPR_REG_NUM_IVOR_BASE + 6,
    SPR_REG_NUM_IVOR7  = SPR_REG_NUM_IVOR_BASE + 7,
    SPR_REG_NUM_IVOR8  = SPR_REG_NUM_IVOR_BASE + 8,
    SPR_REG_NUM_IVOR9  = SPR_REG_NUM_IVOR_BASE + 9,
    SPR_REG_NUM_IVOR10 = SPR_REG_NUM_IVOR_BASE + 10,
    SPR_REG_NUM_IVOR11 = SPR_REG_NUM_IVOR_BASE + 11,
    SPR_REG_NUM_IVOR12 = SPR_REG_NUM_IVOR_BASE + 12,
    SPR_REG_NUM_IVOR13 = SPR_REG_NUM_IVOR_BASE + 13,
    SPR_REG_NUM_IVOR14 = SPR_REG_NUM_IVOR_BASE + 14,
    SPR_REG_NUM_IVOR15 = SPR_REG_NUM_IVOR_BASE + 15,
    SPR_REG_NUM_IVPR = 63,
    SPR_REG_NUM_LR = 8,
    SPR_REG_NUM_MCSRR0 = 570,
    SPR_REG_NUM_MCSRR1 = 571,
    SPR_REG_NUM_MCSR_RW = 572,
    SPR_REG_NUM_MCSR_CO = 828,
    SPR_REG_NUM_MMUBE0 = 820,
    SPR_REG_NUM_MMUBE1 = 821,
    SPR_REG_NUM_MMUCR = 946,
    SPR_REG_NUM_PMUCC0 = 858,
    SPR_REG_NUM_PID = 48,
    SPR_REG_NUM_PIR = 286,
    SPR_REG_NUM_PVR = 287,
    SPR_REG_NUM_PWM = 886,
    SPR_REG_NUM_RMPD = 825,
    SPR_REG_NUM_RSTCFG = 923,
    SPR_REG_NUM_SRR0 = 26,
    SPR_REG_NUM_SRR1 = 27,
    SPR_REG_NUM_SPRG0 = 272,
    SPR_REG_NUM_SPRG1 = 273,
    SPR_REG_NUM_SPRG2 = 274,
    SPR_REG_NUM_SPRG3 = 275,
    SPR_REG_NUM_SPRG4 = 276,
    SPR_REG_NUM_SPRG5 = 277,
    SPR_REG_NUM_SPRG6 = 278,
    SPR_REG_NUM_SPRG7 = 279,
    SPR_REG_NUM_SPRG8 = 604,
    ...
    SPR_REG_NUM_TCR = 340,
    SPR_REG_NUM_TSR_RC = 336,
    SPR_REG_NUM_TSR_WO = 848,
    SPR_REG_NUM_ISPCR = 829,
    SPR_REG_NUM_USPCR = 831,
    SPR_REG_NUM_USPGR0 = 256,
};
